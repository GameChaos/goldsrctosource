...
COVERAGE(HMM_NegateVec2Op, 1)
HMM_INLINE hmm_vec2 operator-(hmm_vec2 vec)
{
    ASSERT_COVERED(HMM_NegateVec2Op);
	
    hmm_vec2 Result = {-vec.X, -vec.Y};
	
    return (Result);
}

COVERAGE(HMM_NegateVec3Op, 1)
HMM_INLINE hmm_vec3 operator-(hmm_vec3 vec)
{
    ASSERT_COVERED(HMM_NegateVec3Op);
	
    hmm_vec3 Result = {-vec.X, -vec.Y, -vec.Z};
	
    return (Result);
}

COVERAGE(HMM_NegateVec4Op, 1)
HMM_INLINE hmm_vec4 operator-(hmm_vec4 vec)
{
    ASSERT_COVERED(HMM_NegateVec4Op);
	
    hmm_vec4 Result = {-vec.X, -vec.Y, -vec.Z, -vec.W};

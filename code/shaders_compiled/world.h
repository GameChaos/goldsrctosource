...
/*
    ...
    Cmdline:
        sokol-shdc --input /media/F/git/goldsrctosource/project/code/shaders/world.glsl --output /media/F/git/goldsrctosource/project/code/shaders_compiled/world.h --slang glsl410:hlsl4:metal_macos -b
